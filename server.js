...
<table role="presentation" width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;background:#ffffff;border-radius:12px;overflow:hidden;border:1px solid #e5e7eb">
  ...
  <tr><td style="padding:12px 32px 26px"><p style="font-family:Arial,sans-serif;font-size:14px;line-height:1.55;color:#374151;margin:0">Thank you,<br><strong>Logan Hauser</strong><br><span style="color:#6b7280">Buildoly</span><br><a href="mailto:logan@buildoly.com" style="font-size:13px;color:#6b7280;text-decoration:none">logan@buildoly.com</a><br><a href="tel:+12137283041" style="font-size:13px;color:#6b7280;text-decoration:none">213-728-3041</a></p></td></tr>
