...
async function initDb() {
  ...
  _initDbPromise = pool.query(`
    ...
    ALTER TABLE projects ADD COLUMN IF NOT EXISTS warranty_welcomed_at TIMESTAMPTZ;
...
require('./subs-v2-routes')({ app, pool, requireAuth, initDb, verifySubLicense });   // /subs/v2 — server-paged rebuild, runs alongside /subs
...
<table role="presentation" width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;background:#ffffff;border-radius:12px;overflow:hidden;border:1px solid #e5e7eb">
  ...
  <tr><td style="padding:12px 32px 26px"><p style="font-family:Arial,sans-serif;font-size:14px;line-height:1.6;color:#6b7280;margin:0"><span style="color:#374151">Thank you,</span><br><strong style="color:#111827">Logan Hauser</strong><br>Buildoly<br><a href="mailto:logan@buildoly.com" style="color:#6b7280;text-decoration:none">logan@buildoly.com</a><br><a href="tel:+12132479512" style="color:#6b7280;text-decoration:none">213-247-9512</a></p></td></tr>
